...
const ResetPassword = () => {
    ...
    const { uid, token, username } = useParams();
                ...
                >
                    { !sendResultOk && resultLottie == 'wait' && (
                        <div className='w-full surface-card py-8 px-5 sm:px-8' style={{ borderRadius: '53px' }}>
                            <label htmlFor='username' className='block text-900 text-xl font-bold mb-2'>
                                Reestablecer contraseña
                            </label>
                            <label htmlFor='username' className='block text-900 font-light text-xl mb-6'>
                                Estimado {username}, captura y confirma tu nueva contraseña.
                            </label>
                            <div className='mb-5'>
                                <div className='mb-5'>
                                    ...
                                    <Password 
                                        ...
                                        toggleMask 
                                        className='w-full' 
                                        inputClassName={classNames({ 'p-invalid': enterResetPassword && password == '' }, 'w-full md:w-35rem')}
                                ...
                                <div>
                                    ...
                                    <Password 
                                        ...
                                        toggleMask 
                                        className='w-full' 
                                        inputClassName={classNames({ 'p-invalid': enterResetPassword && confirmPassword == '' }, 'w-full md:w-35rem')}
                                        onKeyDown={e => e.key === 'Enter' && handleReset()}
                                    />
                                    {
