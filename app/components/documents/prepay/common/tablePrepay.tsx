...
interface TableNcProps {
    ...
    openPrepayBodyTemplate?: (rowData: any) => any;
}

export const TablePrepayments = ({
    lNc,
    setLNc,
    getLNc,
    columnsProps,
    ...
    return (
        <>
            ...
            >
                ...
                <Column field="id_dps" header={''} footer={''} body={openPrepayBodyTemplate} hidden={ columnsProps?.openPrepay.hidden } />
            </DataTable>
        </>
    );
};