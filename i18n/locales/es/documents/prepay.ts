const prepay = {
    ...
    titleUploadTooltipProvider: "Cargar proformas",
    titleAccepted: "Proformas revisadas",
    titleAcceptedTooltip: "Proformas revisadas",
    titleRejected: "Proformas rechazadas en la revisión",
    titleRejectedTooltip: "Proformas rechazadas en la revisión",
    titleAuthNc: "Autorizaciones de proformas pendientes para mí",
    titleAuthorizedNc: "Proformas autorizadas",
    titleAuthorizedNcTooltip: "Proformas autorizadas",
    titleInProcessNc: "Proformas en autorización",
    titleInProcessNcTooltip: "Proformas en autorización",
    titleRejectedNc: "Proformas rechazadas en la autorización",
    titleRejectedNcTooltip: "Proformas rechazadas en la autorización",
